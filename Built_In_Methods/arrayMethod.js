...
let d = [5,6,7,8,9,8,2]
console.log("shift",d.shift()) // shifted element return karta hai  //start se remove karta hai
console.log("unshift",d.unshift(12)) // It will return total length after add number  // start me add karta hai
...
const allEven = number.every((num) => num % 2 === 0); // every one should follow condition then return true
console.log(allEven); // true, sabhi even hain


const numbers = [1, 3, 5, 8, 9];  // Check karo kya array me koi even number hai
const hasEven = numbers.some((num) => num % 2 === 0); // koi ek true hoga to true return karega
